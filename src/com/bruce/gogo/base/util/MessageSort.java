...
import com.bruce.gogo.entity.QunMessage;
...
public class MessageSort {
	 ...
	 * @throws Exception 
	 */
	public List<QunMessage> sortQQ(InputStream inputStream) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public List<QunMessage> sortQQ(String filePath) throws Exception {
	 ...
	 * @return Map<String, Integer>
	 */
	public List<QunMessage> toQQInfp(BufferedReader bfr) {
		...
		List<QunMessage> qms = new ArrayList<QunMessage>();//存放排序后的数据
		try {
