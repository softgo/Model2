package com.bruce.gogo.security;
...
public class MyUserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		//取得用户的权限
		SysUser users = userDao.findByName(username);
		if  (users==null)  
	...
	private Set<GrantedAuthority> obtionGrantedAuthorities(SysUser user) {
		List<Resource> resources = resourceDao.getUserResources(String.valueOf(user.getUserId()));
