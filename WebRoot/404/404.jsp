...
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="<%=request.getContextPath()%>/404/1.gif" width="17" height="18"></TD>
    <TD width="100%" 
    background="<%=request.getContextPath()%>/404/3.gif"></TD>
    <TD><IMG 
src="<%=request.getContextPath()%>/404/2.gif" width="17" height="18"></TD>
  </TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
background="<%=request.getContextPath()%>/404/left.gif"></TD>
...
//-->
    ...
    <TD width=7 
    background="<%=request.getContextPath()%>/404/right.gif"></TD></TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
        ...
        <TR>
          <TD class=bg_1 align=middle height=300>
            <TABLE cellSpacing=0 cellPadding=0 width=590 border=0>
              ...
              <TR>
                <TD align=right><IMG 
                  src="<%=request.getContextPath()%>/404/center_error.gif" width="450" height="32" 
                  border=0></TD>
              </TR>
              <TR>
                <TD align=middle height=380>
                  <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                    <TBODY>
                    <TR>
                      <TD colSpan=3><IMG height=42 src="<%=request.getContextPath()%>/404/error_r1_c1.gif"  width=534 border=0></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD rowSpan=2><IMG height=239 
                        src="<%=request.getContextPath()%>/404/error_r2_c1.gif" 
                      ...
                      height=228>
                        ...
                        <P>蓝缘欢迎你.........</P></TD>
                      <TD rowSpan=2><IMG height=239 
                        src="<%=request.getContextPath()%>/404/error_r2_c3.gif" 
                        width=12 border=0></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD><IMG height=11 
                        src="<%=request.getContextPath()%>/404/error_r3_c2.gif" 
  ...
  <TR>
    <TD class=bg align=middle width=*>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><IMG src="<%=request.getContextPath()%>/404/4.gif" width="17" height="18"></TD>
          <TD width="100%" 
          background="<%=request.getContextPath()%>/404/6.gif"></TD>
          <TD><IMG 
        src="<%=request.getContextPath()%>/404/5.gif" width="17" height="18"></TD>
        </TR></TBODY></TABLE><BR>
