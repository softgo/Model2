...
<a href="javascript:void(0);"  class="STYLE4" onclick="pageNow('1');">
	首页
</a>

<c:if test="${pageView.pageNow eq 1}">
<span class="disabled"  class="STYLE4">
	上一页
</span>

</c:if>
<c:if test="${pageView.pageNow ne 1}">
<a href="javascript:void(0);"  class="STYLE4" onclick="return pageNow('${pageView.pageNow - 1}')">
	上一页
</a>
</c:if>
...
<a href="javascript:void(0);"  class="STYLE4" onclick="pageNow('${pageView.pageNow + 1}')">
 	下一页
 </a>	
</c:if>
...
<span class="disabled"  class="STYLE4">
 ...
 <a href="javascript:void(0);"  class="STYLE4" onclick="pageNow('${pageView.pageCount}')">
	尾页
 </a>
</div>