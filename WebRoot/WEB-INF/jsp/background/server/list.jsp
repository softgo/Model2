...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/fenyecss.css" />
  ...
  <body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/serverInfo/find.html" method="post">
<table width="100%">
  <tr>
    ...
    <td><table class="listtable" width="100%">
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">当前cpu使用率</span></td>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">预设cpu使用率</span></td>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">当前Jvm使用率</span></td>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">预设Jvm使用率</span></td>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">当前内存使用率</span></td>
            <td width="8%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">预设内存使用率</span></td>
            <td width="10%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">超出预设发送邮件</span></td>
            <td width="10%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">发送时间</span></td>
            <td width="14%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">备注</span></td>
          </tr>
	  ...
	  <tr>
	    <td height="35" background="<%=request.getContextPath()%>/images/tab_19.gif"><%@include file="../../common/webfenye.jsp" %>
	    </td>
	  </tr>
    </table>
   </form>
