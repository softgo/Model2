...
<body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/syslog/find.html" method="post">
<table width="100%">
  <tr>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onMouseOver="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="5%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">模块</span></td>
            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">执行操作</span></td>
            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">花费时间</span></td>
            <td width="15%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">执行时间</td>
  ...
  <tr>
    <td height="35" background="<%=request.getContextPath()%>/images/tab_19.gif"><%@include file="../../common/webfenye.jsp" %>    </td>
  </tr>
</table>
</form>
</body>
