...
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/syslog/findlogin.html" method="post">
  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				...
				用户ID：<input type="text" name="tempId" value="${userId}" style="height: 20px"/>　
    ...
    <table class="listtable" width="100%" >
      <tr>
        ...
        <table class="ttab" width="100%" cellspacing="1" onMouseOver="changeto()"  onmouseout="changeback()" >
            <tr>
	 			<td width="5%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">登陆ID</span></td>
	            ...
	            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">登陆时间</span></td>
	            <td width="15%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">登陆IP</td>
            </tr>
          ...
          <c:forEach var="loginList" items="${pageView.records}">
	          <tr>
	            ...
	            <td height="20" ><span class="STYLE1"><fmt:formatDate value="${loginList.loginTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span></td>
