...
<script type="text/javascript">
	...
	function permissio(id){
		 var url = "<%=request.getContextPath()%>/background/resources/permissioRole.html?roleId="+id;
		 var h_sp1 = 400;
		 var w_sp1 = 350;
...
<body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/sysrole/find.html" method="post">
<table width="100%">
  <tr>
                  ...
                  <tr>
                    ...
                    <td class="STYLE1">
	                  <sec:authorize ifAnyGranted="ROLE_sys_role_add">
	                    <a href="<%=request.getContextPath()%>/background/sysrole/addUI.html">新增</a>
	                  </sec:authorize>
                    </td>
                  </tr>
                </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <sec:authorize ifAnyGranted="ROLE_sys_role_info">
	            <img src="<%=request.getContextPath()%>/images/admin.gif" width="10" height="10" />
	            <a href="<%=request.getContextPath()%>/background/sysrole/getById.html?roleId=${role.id}&&typeKey=0">
	                            详细信息
	            </a>
            </sec:authorize>
            ...
            <sec:authorize ifAnyGranted="ROLE_sys_role_edit">
	            ...
	            <a href="<%=request.getContextPath()%>/background/sysrole/getById.html?roleId=${role.id}&&typeKey=1">
	                            编辑
	            </a>
            </sec:authorize>
            ...
            <sec:authorize ifAnyGranted="ROLE_sys_role_delete">
            	...
            	<a href="javascript:void(0);" onclick="deleteId('<%=request.getContextPath()%>/background/sysrole/deleteById.html?roleId=${role.id}')">
            	删除</a>
            </sec:authorize>
            	</span></td>
          </tr>
