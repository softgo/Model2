 ...
 <script type="text/javascript">
	  ...
	  $(function (){
	  		$("#name").change(function(){
				...
				if(name != null && name != ''){
					$.ajax({
						url:'<%=request.getContextPath()%>/background/sysrole/findByName.html',
						data:{"name":name},
						type : "POST",
...
<br/>
<br/>  
<form action="<%=request.getContextPath()%>/background/sysrole/add.html" method="post" name="roleFrom" id="roleFrom" >
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
							 <input style="height: 20px;width: 200px" name="name" id="name" type="text"/>
						</div>
					</td>
				</tr>
				<tr>	
