...
<body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/resources/find.html" method="post">
<table width="100%">
  <tr>
                  ...
                  <tr>
                    ...
                    <td class="STYLE1">
                    	 ...
                    	 <sec:authorize ifAnyGranted="ROLE_sys_resc_addUI">
                   		 	<a href="<%=request.getContextPath()%>/background/resources/addUI.html">新增</a>
                   		 </sec:authorize>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="10%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">资源KEY</span></td>
          ...
          <tr>
            ...
            <sec:authorize ifAnyGranted="ROLE_sys_res_info">
            <img src="<%=request.getContextPath()%>/images/admin.gif" width="12" height="12" />
            	<a href="<%=request.getContextPath()%>/background/resources/getById.html?resourcesId=${resources.id}&&typeKey=0">
            	显示详细信息</a>
			</sec:authorize>
			
            <sec:authorize ifAnyGranted="ROLE_sys_res_edit">
            <img src="<%=request.getContextPath()%>/images/edt.gif" width="12" height="12" />
            <a href="<%=request.getContextPath()%>/background/resources/getById.html?resourcesId=${resources.id}&&typeKey=1">
                编辑
            </a>
            </sec:authorize>
            ...
            <img src="<%=request.getContextPath()%>/images/del.gif" width="12" height="12" />
            	<a href="javascript:void(0);" onclick="deleteId('<%=request.getContextPath()%>/background/resources/deleteById.html?resourcesId=${resources.id}')">
            	删除</a>
            </sec:authorize>
            	</span></td>
          </tr>
