...
<br/>
<br/>  
<form action="<%=request.getContextPath()%>/background/resources/update.html" method="post"  name="sourceForm" id="sourceForm" >
	<input type="hidden" name="id" value="${resources.id}">
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="name" id="name" value="${resources.name}"/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="resKey" id="resKey" value="${resources.resKey}"/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td>
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="resUrl" id="resUrl"  value="${resources.resUrl}"/>
						</div>
					</td>
				</tr>
				<tr>	
