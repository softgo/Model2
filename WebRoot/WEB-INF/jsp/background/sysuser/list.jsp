...
function userRole(id){
	 var url = "<%=request.getContextPath()%>/background/sysuser/userRole.html?userId="+id;
	 var h_sp1 = 420;
	 var w_sp1 = 600;
...
<body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/sysuser/find.html" method="post">
<table width="100%">
  <tr>
		                  ...
		                  <tr>
		                    ...
		                    <td class="STYLE1"><div align="center">
		                    	...
		                    	<sec:authorize ifAnyGranted="ROLE_sys_user_addUI">
			                    	<a href="<%=request.getContextPath()%>/background/sysuser/addUI.html">
				                    	新增
			                    	</a>
		                    	</sec:authorize>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">用户名</span></td>
            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif" ><span class="STYLE1">所属角色</span></td>
            <td width="12%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">昵称</td>
            <td width="15%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">注册时间</td>
            <td width="15%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">最后一次登录时间</td>
            <td width="3%" height="22" background="<%=request.getContextPath()%>/images/bg.gif"  class="STYLE1">等级</td>
          ...
          <tr>
            ...
            <td height="20" ><span class="STYLE1"><a href="<%=request.getContextPath()%>/background/user/getById.html?userId=${key.userId}&&type=0">${key.userName}</a></span></td>
            ...
            <td height="20" >
           	 <span class="STYLE1">${key.level}</span>
            </td>
            ...
            <span class="STYLE4">
            	...
            	<sec:authorize ifAnyGranted="ROLE_sys_user_info">
	            <img src="<%=request.getContextPath()%>/images/admin.gif" width="10" height="10" />
	            <a href="<%=request.getContextPath()%>/background/sysuser/getById.html?userId=${key.userId}&type=0">
	            		详细信息</a>
	           </sec:authorize>
            
	            <sec:authorize ifAnyGranted="ROLE_sys_user_edit">
	            <img src="<%=request.getContextPath()%>/images/edt.gif" width="12" height="12" />
	            <a href="<%=request.getContextPath()%>/background/sysuser/getById.html?userId=${key.userId}&type=1">编辑</a>
	           </sec:authorize>
	           
	           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
	            <img src="<%=request.getContextPath()%>/images/del.gif" width="16" height="16" />
	           	<a href="javascript:void(0);" onclick="deleteId('<%=request.getContextPath()%>/background/sysuser/deleteById.html?userId=${key.userId}');">
	           	删除</a>
	           	</sec:authorize>
            </span>
