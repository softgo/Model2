...
function change(v,s,a)
{
		var sel_tag = "0";
		for(var i=0; i<v; i++)
		{
			sel_tag += "_"+(document.getElementById(s[i]).selectedIndex-1);
		}
		...
		{		
			...
			var arr;
			var arr_len = 0, sel;
			if(dsy.Exists(sel_tag))
			{
				arr = dsy.Items[sel_tag].concat();
				if(arr[0] != "")
				{
					arr.unshift("");			
				}
				...
				{						
					...
					if(sel >= arr_len && arr[arr_len - 1]!= a[v]) 
					{
						arr_len = arr.push(a[v]);		
						sel = arr_len - 1;			
					}			
				}
				else
			...
			for(i=0; i<arr_len; i++)
			{					
				options[i] = new Option(arr[i],arr[i]);
				if(i == sel)
				{
...
dsy.add("0_0",["北京","安徽","福建","甘肃","广东","广西","贵州","海南","河北","河南","黑龙江","湖北","湖南","吉林","江苏","江西","辽宁","内蒙古","宁夏","青海","山东","山西","陕西","上海","四川","天津","西藏","新疆","云南","浙江","重庆","香港","台湾"]); 
dsy.add("0_0_0",["北京","东城区","西城区","朝阳区","崇文区","海淀区","宣武区","石景山区","门头沟区","丰台区","房山区","大兴区","通州区","顺义区","平谷区","昌平区"]); 
...
//改动.
dsy.add("0_0_23",["上海","黄浦区","徐汇区","长宁区","静安区","普陀区","闸北区","虹口区","杨浦区","青浦区","奉贤区","闵行区","宝山区","嘉定区","浦东新区","金山区","松江区","崇明县"]); 
dsy.add("0_0_24",["阿坝藏族羌族自治州","巴中","成都","达州","德阳","甘孜藏族自治州","广安","广元","乐山","凉山彝族自治州","眉山","绵阳","南充","内江","攀枝花","遂宁","雅安","宜宾","资阳","自贡","泸州"]);
//改动.
dsy.add("0_0_25",["天津","和平区","河西区","南开区","河东区","河北区","红桥区","东丽区","津南区","西青区","北辰区","武清区","宝坻区","蓟县","宁河县","静海县","滨海新区"]);
...
//改动.
dsy.add("0_0_30",["重庆","万州区","黔江区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","渝北区","巴南区","长寿区","江津区","合川区","永川区","南川区","綦江区","大足区","铜梁区","璧山区",
"潼南县","荣昌县","梁平县","城口县","丰都县","垫江县","武隆县","忠县","开县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县"]);
//改动. 
dsy.add("0_0_31",["香港","中西区","东区","九龙城区","观塘区","南区","深水埗区","黄大仙区","湾仔区","油尖旺区","离岛区","葵青区","北区","西贡区","沙田区","屯门区","大埔区","荃湾区","元朗区"]); 
dsy.add("0_1_11",["全州市","群山市","益山市","井邑市","南原市","金堤市","完州郡","镇安郡","茂朱郡","长水郡","任实郡","淳昌郡","高敞郡","扶安郡"]); 
dsy.add("0_1_12",["木浦市","丽水市","顺天市","罗州市","光阳市","潭阳郡","谷城郡","求礼郡","高兴郡","宝城郡","和顺郡","长兴郡","康津郡","海南郡","灵岩郡","务安郡","咸平郡","灵光郡","长城郡","莞岛郡","珍岛郡","新安郡"]); 
dsy.add("0_1_13",["浦项市","庆州市","金泉市","安东市","龟尾市","荣州市","永川市","尚州市","闻庆市","庆山市","军威郡","义城郡","青松郡","英阳郡","盈德郡","清道郡","高灵郡","星州郡","漆谷郡","醴泉郡","奉化郡","蔚珍郡","郁陵郡"]); 
dsy.add("0_1_14",["昌原市","晋州市","统营市","泗川市","金海市","密阳市","巨济市","梁山市","宜宁郡","咸安郡","昌宁郡","固城郡","南海郡","河东郡","山清郡","咸阳郡","居昌郡","陜川郡"]); 
dsy.add("0_1_15",["济州市","西归浦市","北济州郡","南济州郡"]); 

//小日本.
dsy.add("0_2",["北海道地方","东北地方","关东地方","中部地方","近畿地方","中国地方","四国地方","九州地方"]); 
dsy.add("0_2_0",["北海道"]); 
dsy.add("0_2_1",["青森县","岩手县","宫城县","秋田县","山形县","福岛县"]); 
dsy.add("0_2_2",["东京都","茨城县","栃木县","群马县","埼玉县","千叶县","神奈川县"]); 
dsy.add("0_2_3",["山梨县","长野县","新潟县","岐阜县","静冈县","爱知县","富山县","石川县","福井县"]); 
dsy.add("0_2_4",["三重县","滋贺县","京都府","大阪府","兵库县","奈良县","和歌山县"]); 
dsy.add("0_2_5",["鸟取县","岛根县","冈山县","广岛县","山口县"]); 
dsy.add("0_2_6",["德岛县","香川县","爱媛县","高知县"]); 
dsy.add("0_2_7",["福冈县","佐贺县","长崎县","熊本县","大分县","宫崎县","鹿儿岛县","冲绳县"]); 

//新加坡.
dsy.add("0_3",["中区","东区","北区","东北区","西区"]); 
dsy.add("0_3_0",["碧山","红山","武吉知马","芽笼","加冷","马林百列","诺维娜","女皇镇","大巴窑","东陵","市中心","南部岛屿"]); 
dsy.add("0_3_1",["勿洛","樟宜","巴耶利峇","淡滨尼","白沙","樟宜湾"]); 
dsy.add("0_3_2",["中央集水区","林厝港","万礼","三巴旺","新邦","双溪加株","义顺","兀兰"]); 
dsy.add("0_3_3",["宏茂桥","后港","榜鹅","实里达","盛港","实龙岗","东北岛屿"]); 
dsy.add("0_3_4",["武吉巴督","武吉班让","文礼","蔡厝港","金文泰","裕廊东","裕廊西","先驱","登加","大士","西部岛屿","西部集水区"]); 
